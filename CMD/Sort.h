...
int partition(int arr[], int l, int r, long long& d);
void quickSort(int arr[], int l, int r, long long& d);
void countingSort(int arr[], int n, long long& d);
int getMax(int arr[], int n, long long& d);
int digit(int a, int k, long long& d);
void countSort(int arr[], int n, int exp, long long& d);
void radixSort(int arr[], int n, long long& d);
